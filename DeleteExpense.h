...
namespace GUIpractice {
	...
	/// <summary>
	/// Summary for DeleteExpense
	/// </summary>
	public ref class DeleteExpense : public System::Windows::Forms::Form
	{
	private:
		String^ username;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Click += gcnew System::EventHandler(this, &DeleteExpense::Label1_Click);
			// 
			// textBox_Name
			// 
			...
			this->textBox_Name->TextChanged += gcnew System::EventHandler(this, &DeleteExpense::TextBox_Name_TextChanged);
			// 
			// label2
			// 
			...
			this->label4->Text = L"Date Deleted:";
			// 
			// textBox2
			// 
			...
			this->textBox2->TextChanged += gcnew System::EventHandler(this, &DeleteExpense::textBox2_TextChanged);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &DeleteExpense::Button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &DeleteExpense::Button2_Click);
			// 
			// comboBox1
			// 
			...
			this->dataGridView1->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &DeleteExpense::DataGridView1_CellContentClick);
			// 
			// button3
			// 
			...
			this->Name = L"DeleteExpense";
			this->Text = L"DeleteExpense";
...
#pragma endregion
		private: System::Void y_Load(System::Object^ sender, System::EventArgs^ e) {
	...
	private: System::Void Button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		SqlCommand^ cmd = gcnew SqlCommand("DELETE [expTrackerApp].[dbo].[expense2] WHERE expense_date=(@expense_date) AND expense_amount=(@expense_amount) AND expense_attribute=(@expense_attribute) AND expense_Name=(@expense_name) AND user_name=(@user_name)", con);
